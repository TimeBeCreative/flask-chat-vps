...
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get("DATABASE_URL", "postgresql://postgres.trdofkwvgjdpwcovwahe:Vika123Che123Vika@aws-0-eu-central-1.pooler.supabase.com:6543/postgres")
